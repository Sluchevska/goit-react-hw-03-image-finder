...
export default class App extends Component {
  ...
  render() {
    ...
    const idle = reqStatus === "idle";
    const pending = reqStatus === "pending";
    const resolved = reqStatus === "resolved";
    return (
      <div>
        {idle && <SearchBar onSearch={this.handleFormSubmit} />}
        {
          (pending && <SearchBar onSearch={this.handleFormSubmit} />,
          (<Loader />),
          (
            <ImageGallery
              pictures={pictures}
